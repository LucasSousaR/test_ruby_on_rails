...
class CreateMunicipiosTest < ApplicationSystemTestCase
  setup do
  ...
  test "creating a Create municipio" do
    visit municipios_url
    click_on "New Municipio"

    click_on "Create municipio"

    assert_text "Create municipio was successfully created"
    click_on "Back"
  end

  test "updating a Create municipio" do
    visit municipios_url
