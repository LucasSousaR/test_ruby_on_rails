...
%o`, message, error2, detail);
  ...
  var context_menu_controller_default = class extends Controller {
    ...
    toggleMenuOptions(hide2) {
      this.showLinkTarget.classList.toggle("hidden", hide2);
      this.editLinkTarget.classList.toggle("hidden", hide2);
      this.deleteLinkTarget.classList.toggle("hidden", hide2);
    }
    ...
    shouldHideMenu(event) {
      return !this.menuTarget.contains(event.target) || event.target === this.menuTarget || event.target.closest("a");
    }
  };
  ...
  application.register("context-menu", context_menu_controller_default);
